      ...
      <div className="space-y-12">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          <div className="md:text-right md:pr-12">
            <Badge className="mb-2 bg-orange-500 hover:bg-orange-600">10:00 AM - 12:00 PM</Badge>
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="md:pl-12">
            <Badge className="mb-2 bg-purple-500 hover:bg-purple-600">12:00 PM - 1:00 PM</Badge>
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          <div className="md:text-right md:pr-12">
            <Badge className="mb-2 bg-blue-500 hover:bg-blue-600">1:00 PM - 3:00 PM</Badge>
